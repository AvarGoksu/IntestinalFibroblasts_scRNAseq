...
```{r}
# res <- test_de(fit, contrast = cond(stage_grouped = "uninfected_adult", identity = "Cd81+ FB") -
#                                (cond(stage_grouped = "uninfected_adult", identity = "PdgfraloCd55+ FB") + cond(stage_grouped = "uninfected_adult", identity = "Pdgfrahi FB")),
#                max_lfc = 5,
#                verbose = TRUE) %>%
