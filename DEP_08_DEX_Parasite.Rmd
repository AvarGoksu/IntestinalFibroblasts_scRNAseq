...
```{r}
# res <- test_de(fit, contrast = cond(stage_grouped = "repair", identity_simplified = "PdgfrahiCd55posFB") -
#                                cond(stage_grouped = "uninfected_adult", identity_simplified = "PdgfrahiCd55posFB"),
#                max_lfc = 5,
#                verbose = TRUE) %>%
