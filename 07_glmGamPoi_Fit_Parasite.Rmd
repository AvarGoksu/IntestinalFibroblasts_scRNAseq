...
for (identity_col in identity_columns) {
  ...
  file_name <- paste0("/vol/ExtraVol/ParasiteDEX/ParasiteDEX_PairwiseMarkerResults_", gsub("\\s+|\\+|\\-", "_", identity_col), ".xlsx")
  
  # Save the result to an Excel file
  write.xlsx(res, file_name, overwrite = TRUE)
  
  # Print a message indicating completion of the current identity
  message(paste("Completed and saved results for", identity_col, "to", file_name))
}
...
```{r}
saveRDS(fit, "/vol/ExtraVol/ParasiteDEX/parasite_glmGamPoi_fit_full.RDS")
```
