...
write.xlsx(res_interaction_merged, "/vol/ExtraVol/DEX_results_parasite_interaction_pseudobulked.xlsx")
```
...
write.xlsx(res_infection_merged, "/vol/ExtraVol/DEX_results_parasite_infection_pseudobulked.xlsx")
```
